...
// is 0. There should be no duplicates, i.e., no triplet should be repeated, irrespective
// of order of the numbers.
...
// 0 <= |nums[i]| <= 10^6, where nums[i] represents value of each element in the array
// Input array contains only integers

// 🖨️ OUTPUT FORMAT 🖨️
// Return an array of arrays
// You must return all such unique triplets which sum to 0 from the given array
// If no such triplet can be found, return an empty array
